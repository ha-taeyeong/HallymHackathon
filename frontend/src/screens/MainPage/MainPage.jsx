...
const MainPage = () => {
  ...
  }, [selectedSkill]); // selectedSkill이 바뀔 때마다 리스너 재설정
  ...
  return (
    <div className="bg-white min-h-screen w-full font-pretendard">
      ...
      <main className="pt-[100px] max-w-7xl mx-auto px-6">
        ...
        {/* 2. About us Section */}
        <section id="about" className="mb-40 scroll-mt-32"> {/* 여백을 조금 더 줌 */}
        ...
        {/* 3. Memo Section */}
        <section id="memo-info" className="mb-40 scroll-mt-32">
